              ...
              <body>
                  <script>
                      Swal.fire({
                          ...
                          window.location = 'http://localhost/AceSchedule-main2/Painel%20Admin%20Salas%20-%20Ace%20Schedules/';
                      });
                  </script> 
              </body>
        ";
              ...
              <body>
                  <script>
                      Swal.fire({
                          ...
                          window.location = 'http://localhost/AceSchedule-main2/Painel%20-%20Ace%20Schedules/painel.php';
                      });
                  </script> 
              </body>
        ";
          ...
          <body>
              <script>
                  Swal.fire({
                      icon: 'error',
                      title: 'Oops...',
                      text: 'Email e/ou senha icorretos',
                  }).then(function() {
