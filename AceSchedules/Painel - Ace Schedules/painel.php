    ...
    <header>
        ...
        <div class="sub-bar">
            ...
            <div class="subbarLinks">
                ...
                <div class="barSocial">
                    <a href="https://instagram.com/aceschedules?igshid=MzRlODBiNWFlZA=="><img src="img/instagram.png" class="socialLinks"></a>
                    <a href="https://br.linkedin.com/school/escola-tecnica-pandia-calogeras/"><img src="img/linkedin.png" class="socialLinks"></a>
                    <a href="https://github.com/Sacul-Lucas/AceSchedule"><img src="img/github.png" class="socialLinks"></a>
                </div>
            </div>
        ...
        <div class="listmenu" id="listmenu">
               <button onclick="window.location='http://localhost/AceSchedules/Pagina-Introdu%c3%a7%c3%a3o/agendamento-index.html'" class="barrmenulink"> Home</button>
               <button onclick="window.location='http://localhost/AceSchedules/Painel%20-%20Ace%20Schedules/painel.php'" class="barrmenulink"> Painel de salas</button>
               <button onclick="window.location='https://fundacaocsn.org.br/#contact'" class="barrmenulink"> Contato</button>
        </div>
