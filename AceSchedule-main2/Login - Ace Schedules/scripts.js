...
const btn_voltar3 = document.getElementById(`btn-voltar`)
...
const btn_voltar4 = document.getElementById(`btn-voltar`)
...
const btn_voltar5 = document.getElementById(`btn-voltar`)
